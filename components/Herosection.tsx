...
export default function HeroSection() {
    ...
    return (
<section className="md:h-screen gap-4 md:gap-0 flex flex-col justify-center items-start">
      <div className="flex items-center gap-4 relative">
        {isCopied ? <p className="absolute top-0 -right-20 transition-all duration-500 text-sm text-primarycolor">Copied</p> : ""}
        <p className="text-xs md:text-sm text-white/30">0x66756c6c737461636b206d656368616e6963</p>
